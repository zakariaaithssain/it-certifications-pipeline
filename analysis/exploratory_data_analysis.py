...
class EDA:
    ...
    def nbre_certification_per_lvl_and_provider(self, axe, st = False): #in case integrated with st we use st = True
        ...
        if st: streamlit.pyplot(axe.figure)



    def avg_cost_per_lvl_and_provider(self, axe, st = False):
    ...
    def avg_duration_per_lvl_and_provider(self, axe, st = False):
    ...
    def top_five_languages(self, axe, st = False):
    ...
    def cost_distribution(self, axe, st = False):
    ...
    def duration_distribution(self, axe, st = False):
    ...
    def cost_boxplot(self, axe, st = False):
    ...
    def duration_boxplot(self, axe, st = False):
    ...
    def nbre_certification_per_domain(self, axe, st = False):
