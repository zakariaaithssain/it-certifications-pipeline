...
class EDA:
    ...
    def nbre_certification_per_lvl_and_provider(self, axe):
    ...
    def avg_cost_per_lvl_and_provider(self, axe):
    ...
    def avg_duration_per_lvl_and_provider(self, axe):
    ...
    def top_five_languages(self, axe):
    ...
    def cost_distribution(self, axe):
    ...
    def duration_distribution(self, axe):
    ...
    def nbre_certification_per_domain(self, axe):
